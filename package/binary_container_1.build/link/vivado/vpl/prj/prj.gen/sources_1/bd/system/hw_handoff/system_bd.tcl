...
proc create_root_design { parentCell } {
  ...
  set axi_i2c [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.1 axi_i2c ]

  # Create instance: axi_ic_zynq_ps_S_AXI_HP0_FPD, and set properties
  ...
  # Create instance: axi_inter, and set properties
  set axi_inter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_inter ]
  set_property -dict [ list \
  ...
  # Create instance: axi_inter1, and set properties
  set axi_inter1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_inter1 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {4} \
   CONFIG.NUM_SI {1} \
 ] $axi_inter1

  # Create instance: axi_io, and set properties
  set axi_io [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_io ]
  set_property -dict [ list \
  ...
  # Create instance: cmd_bit, and set properties
  set cmd_bit [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 cmd_bit ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {10} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {13} \
  ...
  # Create instance: fce_ena_bit, and set properties
  set fce_ena_bit [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 fce_ena_bit ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {12} \
   CONFIG.DIN_TO {12} \
   CONFIG.DIN_WIDTH {13} \
  ...
  if { [catch {set stepper [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: stepper_div, and set properties
  set block_name divider
  set block_cell_name stepper_div
  if { [catch {set stepper_div [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $stepper_div eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.IN_FREQ {200000000} \
   CONFIG.OUT_FREQ {200} \
 ] $stepper_div

  # Create instance: stepper_state, and set properties
  set stepper_state [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 stepper_state ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $stepper_state
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1}\
  ...
  connect_bd_intf_net -intf_net axi_ic_zynq_ps_S_AXI_HP0_FPD_M00_AXI [get_bd_intf_pins axi_ic_zynq_ps_S_AXI_HP0_FPD/M00_AXI] [get_bd_intf_pins zynq_ps/S_AXI_HP0_FPD]
  ...
  connect_bd_intf_net -intf_net axi_inter_M01_AXI [get_bd_intf_pins axi_inter/M01_AXI] [get_bd_intf_pins krnl_vadd_1/s_axi_control]
  connect_bd_intf_net -intf_net krnl_vadd_1_m_axi_gmem [get_bd_intf_pins axi_ic_zynq_ps_S_AXI_HP0_FPD/S00_AXI] [get_bd_intf_pins krnl_vadd_1/m_axi_gmem]
  ...
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins axi_i2c/s_axi_aclk] [get_bd_pins axi_ic_zynq_ps_S_AXI_HP0_FPD/ACLK] [get_bd_pins axi_ic_zynq_ps_S_AXI_HP0_FPD/M00_ACLK] [get_bd_pins axi_ic_zynq_ps_S_AXI_HP0_FPD/S00_ACLK] [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins axi_inter/ACLK] [get_bd_pins axi_inter/M00_ACLK] [get_bd_pins axi_inter/M01_ACLK] [get_bd_pins axi_inter/S00_ACLK] [get_bd_pins axi_inter1/ACLK] [get_bd_pins axi_inter1/M00_ACLK] [get_bd_pins axi_inter1/M01_ACLK] [get_bd_pins axi_inter1/M02_ACLK] [get_bd_pins axi_inter1/M03_ACLK] [get_bd_pins axi_inter1/S00_ACLK] [get_bd_pins axi_io/s_axi_aclk] [get_bd_pins clk_wiz/clk_out1] [get_bd_pins krnl_vadd_1/ap_clk] [get_bd_pins stepper_div/clk_in] [get_bd_pins sys_ret200/slowest_sync_clk] [get_bd_pins zynq_ps/maxihpm0_lpd_aclk] [get_bd_pins zynq_ps/saxihp0_fpd_aclk]
  ...
  connect_bd_net -net stepper_ena [get_bd_ports ena] [get_bd_pins stepper/ena]
  connect_bd_net -net stepper_state_dout [get_bd_pins axi_io/gpio2_io_i] [get_bd_pins stepper_state/dout]
  ...
  connect_bd_net -net sys_ret200_interconnect_aresetn [get_bd_pins axi_ic_zynq_ps_S_AXI_HP0_FPD/ARESETN] [get_bd_pins axi_ic_zynq_ps_S_AXI_HP0_FPD/M00_ARESETN] [get_bd_pins axi_ic_zynq_ps_S_AXI_HP0_FPD/S00_ARESETN] [get_bd_pins axi_inter/M01_ARESETN] [get_bd_pins sys_ret200/interconnect_aresetn]
  connect_bd_net -net sys_ret_peripheral_aresetn [get_bd_pins axi_i2c/s_axi_aresetn] [get_bd_pins axi_intc/s_axi_aresetn] [get_bd_pins axi_inter/ARESETN] [get_bd_pins axi_inter/M00_ARESETN] [get_bd_pins axi_inter/S00_ARESETN] [get_bd_pins axi_inter1/ARESETN] [get_bd_pins axi_inter1/M00_ARESETN] [get_bd_pins axi_inter1/M01_ARESETN] [get_bd_pins axi_inter1/M02_ARESETN] [get_bd_pins axi_inter1/M03_ARESETN] [get_bd_pins axi_inter1/S00_ARESETN] [get_bd_pins axi_io/s_axi_aresetn] [get_bd_pins krnl_vadd_1/ap_rst_n] [get_bd_pins stepper_div/rst] [get_bd_pins sys_ret200/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs zynq_ps/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs zynq_ps/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs zynq_ps/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ps/Data] [get_bd_addr_segs axi_i2c/S_AXI/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ps/Data] [get_bd_addr_segs axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ps/Data] [get_bd_addr_segs axi_io/S_AXI/Reg] -force
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ps/Data] [get_bd_addr_segs krnl_vadd_1/s_axi_control/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs zynq_ps/SAXIGP2/HP0_LPS_OCM]
  ...
  set_property PFM.AXI_PORT {M01_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M02_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M03_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M04_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M05_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M06_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M07_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"}} [get_bd_cells /axi_inter]
  set_property PFM.AXI_PORT {M01_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M02_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M03_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M04_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M05_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M06_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M07_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"}} [get_bd_cells /axi_inter1]
  set_property PFM.CLOCK {clk_out1 {id "2" is_default "true" proc_sys_reset "/sys_ret200" status "fixed" freq_hz "200000000"}} [get_bd_cells /clk_wiz]
  set_property PFM.AXI_PORT {M_AXI_HPM0_FPD {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M_AXI_HPM1_FPD {memport "M_AXI_GP" sptag "" memory "" is_range "false"} S_AXI_HPC0_FPD {memport "S_AXI_HP" sptag "HPC0" memory "" is_range "false"} S_AXI_HPC1_FPD {memport "S_AXI_HP" sptag "HPC1" memory "" is_range "false"} S_AXI_HP0_FPD {memport "S_AXI_HP" sptag "HP0" memory "" is_range "false"} S_AXI_HP1_FPD {memport "S_AXI_HP" sptag "HP1" memory "" is_range "false"} S_AXI_HP2_FPD {memport "S_AXI_HP" sptag "HP2" memory "" is_range "false"} S_AXI_HP3_FPD {memport "S_AXI_HP" sptag "HP3" memory "" is_range "false"}} [get_bd_cells /zynq_ps]
