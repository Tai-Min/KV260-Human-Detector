 ...
 */
void krnl_ranges_to_cloud(const float* rangesBuf, unsigned int single2DScanSize, unsigned int num2DScans, float scan2DStartAngle, float scan2DAngleInc, float stepperStartAngle, float stepperAngleInc, float centerOffset, uint8_t* cloudBuf) {
    FloatData x, y, z;
