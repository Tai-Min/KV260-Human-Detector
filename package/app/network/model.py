...
class UNet(keras.Model):
    ...
    #@tf.function(jit_compile=True)
    def downsample_first_pool(self, res_no_pool):
    ...
    #@tf.function(jit_compile=True)
    def downsample_second_pool(self, res_first_pool):
    ...
    #@tf.function(jit_compile=True)
    def downsample_third_pool(self, res_second_pool):
    ...
    #@tf.function(jit_compile=True)
    def downsample_fourth_pool(self, res_third_pool):
    ...
    def call(self, sample, training=False):
        ...
        # Downsample.
        res_no_pool = self.downsample_no_pool(sample)
        res_first_pool = self.downsample_first_pool(res_no_pool)
