...
--               /home/mateusz/KV260/hardware/hardware.gen/sources_1/bd/hardware/ip/hardware_clk_wiz_1_0/hardware_clk_wiz_1_0_sim_netlist.vhdl
...
entity hardware_clk_wiz_1_0_clk_wiz is
  port (
...
end hardware_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of hardware_clk_wiz_1_0_clk_wiz is
  signal clk_in1_hardware_clk_wiz_1_0 : STD_LOGIC;
  signal clkfbout_buf_hardware_clk_wiz_1_0 : STD_LOGIC;
  signal clkfbout_hardware_clk_wiz_1_0 : STD_LOGIC;
  signal global_hardware_clk_wiz_1_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_hardware_clk_wiz_1_0,
      O => clkfbout_buf_hardware_clk_wiz_1_0
    );
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_hardware_clk_wiz_1_0
    );
...
entity hardware_clk_wiz_1_0 is
  ...
  attribute NotValidForBitStream of hardware_clk_wiz_1_0 : entity is true;
end hardware_clk_wiz_1_0;

architecture STRUCTURE of hardware_clk_wiz_1_0 is
begin
inst: entity work.hardware_clk_wiz_1_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      global => global,
      locked => locked,
