...
HD_PWD='E:/KV260/package/binary_container_1.build/link/vivado/vpl/prj/prj.runs/system_divider_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_divider_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_divider_1_0.tcl
