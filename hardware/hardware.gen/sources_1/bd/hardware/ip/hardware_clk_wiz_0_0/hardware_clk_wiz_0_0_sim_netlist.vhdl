...
--               /home/mateusz/KV260/hardware/hardware.gen/sources_1/bd/hardware/ip/hardware_clk_wiz_0_0/hardware_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : hardware_clk_wiz_0_0
...
entity hardware_clk_wiz_0_0_clk_wiz is
  port (
...
end hardware_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of hardware_clk_wiz_0_0_clk_wiz is
  signal clk_in1_hardware_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_hardware_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_hardware_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_hardware_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_hardware_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_hardware_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_hardware_clk_wiz_0_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_hardware_clk_wiz_0_0,
      O => clk_out3
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hardware_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    clk_out3 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of hardware_clk_wiz_0_0 : entity is true;
end hardware_clk_wiz_0_0;

architecture STRUCTURE of hardware_clk_wiz_0_0 is
begin
inst: entity work.hardware_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
