...
#
# rebuild.tcl: Tcl script for re-creating project 'hardware'
#
# Generated by Vivado on Wed Jan 12 05:55:48 +0100 2022
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/hardware.srcs/sources_1/new/divider.v"]"\
 "[file normalize "$origin_dir/hardware.srcs/sources_1/new/stepper.v"]"\
 "[file normalize "$origin_dir/hardware.srcs/sources_1/bd/system/system.bd"]"\
 "[file normalize "$origin_dir/hardware.srcs/sources_1/new/temp2pwm.v"]"\
 "[file normalize "$origin_dir/hardware.srcs/sources_1/new/pwm.v"]"\
 "[file normalize "$origin_dir/hardware.srcs/constrs_1/new/system.xdc"]"\
 "[file normalize "$origin_dir/hardware.srcs/sim_1/new/temp2pwm_tb.v"]"\
 "[file normalize "$origin_dir/hardware.srcs/sim_1/new/stepper_tb.v"]"\
 "[file normalize "$origin_dir/hardware.srcs/sim_1/new/pwm_tb.v"]"\
 "[file normalize "$origin_dir/hardware.srcs/sim_1/new/divider_tb.v"]"\
  ]
  foreach ifile $files {
...
set_property -name "platform.name" -value "system" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/hardware.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
set_property -name "pfm_name" -value "vendor:lib:system:1.0" -objects $file_obj
...
set file "[file normalize "$origin_dir/hardware.srcs/constrs_1/new/system.xdc"]"
...
set_property -name "target_ucf" -value "[get_files *new/system.xdc]" -objects $obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "temp2pwm_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
if {[string equal [get_runs -quiet synth_1_copy_1] ""]} {
    create_run -name synth_1_copy_1 -part xck26-sfvc784-2LV-c -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set obj [get_runs synth_1_copy_1]
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/hardware.srcs/utils_1/imports/synth_1" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xck26-sfvc784-2LV-c -flow {Vivado Implementation 2021} -strategy "Congestion_SpreadLogic_low" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
